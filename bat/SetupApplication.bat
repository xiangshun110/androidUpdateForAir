...
:: Android packaging
set AND_CERT_NAME="AndroidUpdateANE"
set AND_CERT_PASS=123
set AND_CERT_FILE=cert\airPC.p12
...
set IOS_PROVISION=cert\AndroidUpdateANE.mobileprovision
...
set APP_PACKAGE_XML=applicationPackage.xml
...
set APP_ID=air.AndroidUpdateANE

:: Output packages
set DIST_PATH=dist
set DIST_NAME=AndroidUpdateANE
